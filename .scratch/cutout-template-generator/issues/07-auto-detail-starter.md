...
- Export the current accepted starter detail layer plus any user edits in the printable PDF packet.
...
- [x] PDF export includes the current edited starter detail layer.
- [x] Debug trace export writes `flattened-source.png` and `starter-detail-mask.png`.
